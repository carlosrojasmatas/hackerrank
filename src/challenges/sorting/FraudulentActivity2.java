...
public class FraudulentActivity2 {
    ...
    public static void main(String[] args) {
        FraudulentActivity2 f = new FraudulentActivity2();
        f.showingNotifications();
    }

    public int getMedian(int freq[],int d){
        int prefix_sum[] = new int[freq.length];
        prefix_sum[0] = freq[0];
    ...
    public void showingNotifications() {
...
//        System.out.println(total);
        ...
        System.out.println(getMedian(new int[]{0,1,3,2,1},7));
    }
}
